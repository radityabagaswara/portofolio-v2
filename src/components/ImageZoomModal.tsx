...
const ProjectImageModal = ({ image, close }: props) => {
  return (
    <TransformWrapper
      centerZoomedOut
      centerOnInit
      initialScale={window.innerWidth > 1024 ? 1.0 : 1.9}
    >
      {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
        <React.Fragment>
          <div
            className="fixed z-[61] left-[50%] top-[50%] bg-black/75 w-full h-full"
          ...
          >
            ...
            <TransformComponent>
              <div className="hover:cursor-grab active:cursor-grabbing overflow-y-auto rounded-lg flex items-center justify-center h-screen relative">
                <div className="md:p-4 flex flex-col gap-3 items-center w-screen">
                  <div className="">
                    <img
                      width="0"
                      height="0"
